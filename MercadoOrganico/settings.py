...
ALLOWED_HOSTS = ['amo-bugs.herokuapp.com','amo-system-test.herokuapp.com','amo-system.herokuapp.com','localhost','merkaorganico.herokuapp.com']
...
if ON_CODESHIP:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'd3mr9l5da2ud7l',
            'USER': 'lxnfjznzsyoqji',
            'PASSWORD': '3851841e5b17970ee315a643f5b90d54f05e8d5081e2b51213181f668362bc34',
