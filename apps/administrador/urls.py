...
urlpatterns = (
    ...
    url(r'^crearProductor/$', views.crearProductor, name="crearProductor"),
    ...
    url(r'^guardarProductor/$', views.guardar_productor, name="guardarProductor"),
    ...
    url(r'^listarCooperativa/$', views.listar_cooperativas, name="listarCooperativa")
)
